...
#SBATCH --output=/cluster/project/sachan/jiaxie/results/2b_asdiv_0shot_C15_T2_omega1_mean_act_vec.out
#SBATCH --error=/cluster/project/sachan/jiaxie/results/2b_asdiv_0shot_C15_T2_omega1_mean_act_vec.err
