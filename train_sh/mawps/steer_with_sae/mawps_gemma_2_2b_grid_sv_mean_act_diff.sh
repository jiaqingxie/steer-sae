...
#SBATCH --output=/cluster/project/sachan/jiaxie/results/2b_mawps_0shot_C15_T3_omega1_mean_act_vec.out
#SBATCH --error=/cluster/project/sachan/jiaxie/results/2b_mawps_0shot_C15_T3_omega1_mean_act_vec.err
