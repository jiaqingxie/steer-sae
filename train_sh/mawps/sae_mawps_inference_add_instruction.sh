...
#SBATCH --output=/cluster/project/sachan/jiaxie/results/mawps-gemma2b-inference_add_instruction.out
#SBATCH --error=/cluster/project/sachan/jiaxie/results/mawps-gemma2b-inference_add_instruction.err
